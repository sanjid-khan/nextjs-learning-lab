    ...
    <section className="text-gray-400 bg-gray-900 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="text-2xl font-medium title-font mb-4 text-white tracking-widest uppercase">
            Our Team
          </h1>
        ...
        <div className="flex flex-wrap -m-4">
          {teamMembers.map((member, idx) => (
            <div key={idx} className="p-4 lg:w-1/2 w-full">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div className="grow sm:pl-8">
                  ...
                  <span className="inline-flex">
                    <a className="text-gray-500 cursor-pointer hover:text-indigo-400 transition-colors">
                      <svg
                        fill="none"
                        stroke="currentColor"
                        strokeLinecap="round"
                    ...
                    <a className="ml-2 text-gray-500 cursor-pointer hover:text-indigo-400 transition-colors">
                      <svg
                        fill="none"
                        stroke="currentColor"
                        strokeLinecap="round"
